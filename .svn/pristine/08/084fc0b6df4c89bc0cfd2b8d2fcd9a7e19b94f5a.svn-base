...
namespace AppApi.App_Data
{
    ...
    public partial class Client_T
    {
        ...
        public Nullable<System.DateTime> EDMTime { get; set; }
        ...
        public Nullable<int> ReClientId { get; set; }
        public string ClientLabel { get; set; }
        public Nullable<int> IsHg { get; set; }
        public Nullable<int> IsYj { get; set; }
        public Nullable<System.DateTime> IsYjDate { get; set; }
        public Nullable<int> CGroupS { get; set; }
    }
}

...
namespace AppApi.App_Data
{
    ...
    public partial class Sell_T
    {
        ...
        public Nullable<decimal> Certification { get; set; }
        public Nullable<decimal> SeaFreight { get; set; }
        public Nullable<decimal> Costing { get; set; }
        public Nullable<decimal> DolarCosting { get; set; }
        public Nullable<decimal> BankFreight { get; set; }
        public Nullable<decimal> TestFreight { get; set; }
        public Nullable<decimal> ExpressFreight { get; set; }
